  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 text-gray-900">
      <div className="w-full max-w-sm p-6 shadow-xl rounded-2xl bg-white border border-gray-300">
        <h2 className="text-2xl text-center text-gray-900 font-semibold mb-4">Login</h2>
        <form className="space-y-4">
          ...
          <button type="submit" className="w-full p-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold shadow-md transition duration-300 transform hover:scale-105">Log In</button>
        </form>
      </div>
    </div>
  );
